...
'''<xforms>
  ...
  <Page Text="Page1" fontWeight="normal" fontSize="16px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" Binding="" Width="900px" Height="2216px" backgroundColor="">
    ...
    <Item WidgetType="ListBox" Text="" HelpText="Title" Binding="title" Left="40px" Top="182px" Width="200px" Height="25px" TabIndex="1" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="Label" Text="First name" HelpText="" Binding="first_name" Left="20px" Top="227px" Width="80px" Height="25px" TabIndex="0" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="TextArea" Text="" HelpText="First name" Binding="first_name" Left="40px" Top="244px" Width="250px" Height="100px" TabIndex="2" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="Label" Text="Last name" HelpText="" Binding="last_name" Left="20px" Top="372px" Width="72px" Height="25px" TabIndex="0" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="TextBox" Text="" HelpText="Last name" Binding="last_name" Left="40px" Top="389px" Width="200px" Height="25px" TabIndex="3" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="Label" Text="Sex" HelpText="" Binding="sex" Left="20px" Top="434px" Width="24px" Height="25px" TabIndex="0" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="ListBox" Text="" HelpText="Sex" Binding="sex" Left="40px" Top="451px" Width="200px" Height="25px" TabIndex="4" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="Label" Text="Birthdate" HelpText="" Binding="birthdate" Left="20px" Top="496px" Width="72px" Height="25px" TabIndex="0" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="DatePicker" Text="" HelpText="Birthdate" Binding="birthdate" Left="40px" Top="513px" Width="200px" Height="25px" TabIndex="5" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="Label" Text="Weight(Kg)" HelpText="" Binding="weightkg" Left="20px" Top="558px" Width="80px" Height="25px" TabIndex="0" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="TextBox" Text="" HelpText="Weight(Kg)" Binding="weightkg" Left="40px" Top="575px" Width="200px" Height="25px" TabIndex="6" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="Label" Text="Height" HelpText="" Binding="height" Left="20px" Top="620px" Width="48px" Height="25px" TabIndex="0" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="TextBox" Text="" HelpText="Height" Binding="height" Left="40px" Top="637px" Width="200px" Height="25px" TabIndex="7" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="Label" Text="Is patient pregnant" HelpText="" Binding="is_patient_pregnant" Left="20px" Top="682px" Width="152px" Height="25px" TabIndex="0" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="ListBox" Text="" HelpText="Is patient pregnant" Binding="is_patient_pregnant" Left="40px" Top="699px" Width="200px" Height="25px" TabIndex="8" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="Label" Text="ARVS" HelpText="Please select all anti-retrovirals that the patient is taking" Binding="arvs" Left="20px" Top="744px" Width="32px" Height="25px" TabIndex="0" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="CheckBox" Text="AZT" HelpText="AZT" Binding="azt" ParentBinding="arvs" Left="40px" Top="764px" Width="200px" Height="25px" TabIndex="9" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="CheckBox" Text="ABICVAR" HelpText="ABICVAR" Binding="abicvar" ParentBinding="arvs" Left="40px" Top="784px" Width="200px" Height="25px" TabIndex="10" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="CheckBox" Text="EFIVARENCE" HelpText="EFIVARENCE" Binding="efivarence" ParentBinding="arvs" Left="40px" Top="804px" Width="200px" Height="25px" TabIndex="11" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="CheckBox" Text="TRIOMUNE" HelpText="TRIOMUNE" Binding="triomune" ParentBinding="arvs" Left="40px" Top="824px" Width="200px" Height="25px" TabIndex="12" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="CheckBox" Text="TRUVADA" HelpText="TRUVADA" Binding="truvada" ParentBinding="arvs" Left="40px" Top="844px" Width="200px" Height="25px" TabIndex="13" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    ...
    <Item WidgetType="Label" Text="Region" HelpText="" Binding="region" Left="20px" Top="1464px" Width="48px" Height="25px" TabIndex="0" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="ListBox" Text="" HelpText="Region" Binding="region" Left="40px" Top="1481px" Width="200px" Height="25px" TabIndex="17" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="Label" Text="Sub-Region" HelpText="" Binding="sub_hyphen_region" Left="20px" Top="1526px" Width="80px" Height="25px" TabIndex="0" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="ListBox" Text="" HelpText="Sub-Region" Binding="sub_hyphen_region" Left="40px" Top="1543px" Width="200px" Height="25px" TabIndex="18" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="Label" Text="City" HelpText="" Binding="city" Left="20px" Top="1588px" Width="32px" Height="25px" TabIndex="0" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="ListBox" Text="" HelpText="City" Binding="city" Left="40px" Top="1605px" Width="200px" Height="25px" TabIndex="19" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="Label" Text="Number of children" HelpText="" Binding="children_number" Left="20px" Top="1650px" Width="144px" Height="25px" TabIndex="0" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="TextBox" Text="" HelpText="Number of children" Binding="children_number" Left="40px" Top="1667px" Width="200px" Height="25px" TabIndex="20" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="Label" Text="Details of Children" HelpText="" Binding="details_of_children" Left="20px" Top="1712px" Width="152px" Height="25px" TabIndex="0" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" fontWeight="bold" fontStyle="italic" />
    ...
    <Item WidgetType="Label" Text="Start time" HelpText="" Binding="start_time" Left="20px" Top="1892px" Width="80px" Height="25px" TabIndex="0" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="TimeWidget" Text="" HelpText="Start time" Binding="start_time" Left="40px" Top="1909px" Width="200px" Height="25px" TabIndex="22" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="Label" Text="End time" HelpText="" Binding="endtime" Left="20px" Top="1954px" Width="64px" Height="25px" TabIndex="0" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
    <Item WidgetType="TimeWidget" Text="" HelpText="End time" Binding="endtime" Left="40px" Top="1971px" Width="200px" Height="25px" TabIndex="23" fontSize="12px" fontFamily="Verdana, 'Lucida Grande', 'Trebuchet MS', Arial, Sans-Serif" />
